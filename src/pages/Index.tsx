    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto p-3 md:p-6 space-y-6 md:space-y-8">
        ...
        <section className="bg-card p-4 md:p-6 rounded-lg shadow-sm border">
          ...
          <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-3">
            Перед вами — собранный список требований к этой фиче. Некоторые формулировки составлены некорректно: они могут быть <strong>противоречивыми, неполными, двусмысленными, технически нереализуемыми или противоречить цели создания фичи</strong>.
          </p>
          <p className="text-muted-foreground leading-relaxed text-sm md:text-base mb-3">
